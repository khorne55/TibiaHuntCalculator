...
public class Settings extends JFrame {
	...
	public Settings() {
		...
		BasicArrowButton arrowdown = new BasicArrowButton(
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if ((Double.parseDouble(textField.getText())
						+ Double.parseDouble(textField_2.getText())
						+ Double.parseDouble(textField_1.getText()) + Double
						.parseDouble(textField_3.getText())) == 100) {
		...
		textField_4.setBounds(88, 151, 279, 20);
		contentPane.add(textField_4);
		textField_4.setColumns(10);
		textField_4.setText(Calculations.location);

		JLabel lblLogSave = new JLabel("Log Save");
		lblLogSave.setBounds(21, 155, 57, 14);
		contentPane.add(lblLogSave);

		JButton btnNewButton_1 = new JButton("File Path...");
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JFileChooser fc = new JFileChooser(Calculations.location);
				fc.setFileSelectionMode(JFileChooser.DIRECTORIES_ONLY);
				int fcret = fc.showOpenDialog(contentPane);
				if (fcret == JFileChooser.APPROVE_OPTION) {
					Calculations.location = fc.getSelectedFile()
							.getAbsolutePath();
				}
				textField_4.setText(Calculations.location);
		...
		btnNewButton_1.setBounds(362, 150, 44, 23);
